...
//import 'package:shopping_cart_side_example/categories.dart';
//import 'package:shopping_cart_side_example/homedisplaybuilder.dart';
import 'package:flutterfire_ui/auth.dart';
// import 'package:shopping_cart_side_example/product.dart';

// import '../homedisplaybuilder.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<User?>(
      ...
      builder: (context, snapshot) {
        ...
        return const Home();
        //return Categories(product:  Product(title: 'HAND BAG', image: "assets/images/bag_2.png", id: 2,price: 12500,description: dummyText,),);
      },
    );
  }
}
